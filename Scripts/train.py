...
# this is a very first release of this script,
# so plenty of hard-coding in place!
...
def train() -> None:
    ...
    for ob_class in OBJECT_CLASSES:
        ...
        # as a sanity check, run a cross validation and display results
        ...
        # now create a model without train/test split
        scaler = StandardScaler()
